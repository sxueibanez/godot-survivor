...
const ICON_REGIONS := {
	...
	"sniper_rifle_damage": ["common", Rect2(0, 0, 627, 627)],
	...
	"sniper_rifle_size": ["common", Rect2(627, 0, 627, 627)],
	...
	"sniper_rifle_rate": ["common", Rect2(0, 627, 627, 627)],
	...
	"nine_treasure_health": ["general", Rect2(627, 0, 627, 418)],
	"nine_treasure_move_speed": ["general", Rect2(0, 0, 627, 418)],
	"nine_treasure_extra_attack": ["general", Rect2(627, 836, 627, 418)],
