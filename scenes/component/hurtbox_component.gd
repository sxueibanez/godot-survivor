...
func on_area_entered(other_area: Area2D):
	...
	var critical_hit: Dictionary = GameEvents.get_critical_damage(hitbox_component.damage, hitbox_component.weapon_id)
	health_component.damage(critical_hit["damage"], "", hitbox_component.global_position, "direct", hitbox_component.weapon_id)
